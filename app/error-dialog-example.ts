...
import {XmatMessageDialogComponent, MessageDialogTypes} from "./xmat-message-dialog.component";
...
export class ErrorDialogExample {
  ...
  openConfirmDialog(type:MessageDialogTypes = this.types.info, disableClose: boolean = false): Observable<boolean> {
